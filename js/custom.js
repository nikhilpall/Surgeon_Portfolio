...
(function (jQuery) {
   ...
   jQuery(window).on('load', function (e) {
      ...
      jQuery('.pq-accordion-block .pq-accordion-box').on("click", function () {
         if (jQuery(this).children('div.pq-accordion-details').is(':hidden')) {
            ...
            jQuery(this).removeClass('pq-active').children('div.pq-accordion-details').slideUp('slow');
         }
      });
   ...
   /*==================================================
      [ Whats app fade out ]
      ==================================================*/
   jQuery('.whats-app-div').fadeOut();
   jQuery(window).on("scroll", function () {
      if (jQuery(this).scrollTop() > 250) {
         jQuery('.whats-app-div').fadeIn(1400);
      } else {
         jQuery('.whats-app-div').fadeOut(400);
      }
   });
...
jQuery(window).on("scroll", function () {
   if (jQuery(this).scrollTop() > 10) {
      jQuery("#pq-header").css("position", "relative");
      jQuery("#pq-header").css("z-index", "9");
   }
   else {
      jQuery("#pq-header").css("position", "initial");
   }
});

$(document).ready(function () {
   $("#togle-button").click(function () {
      $("#navbarSupportedContent").css("z-index", "10");
      $("#menu-icon").toggleClass("fa-bars fa-times");
   });
});

$(document).ready(function () {
   $('#menu-service-menu li').click(function () {
      $('#menu-service-menu li').removeClass('current-menu-item');
      ...
      responsive: [
         {
            ...
            settings: {
               slidesToShow: 1 // Change slidesToShow to 1 for mobile view
            }
         }
      ]
   });
...
$(document).ready(function() {
   $(".sub-menu").hide(); // Hide the sub-menu initially
...
$(document).ready(function() {
   $(document).on("click", function(e) {
      if (!$(e.target).closest("#togle-button").length && !$(e.target).closest(".sub-menu").length && !$(e.target).closest(".menu-item:has(.sub-menu)").length) {
...
var placeholderText = "Appointment date";
...
if (!isTouchEventSupported()) {
   ...
   dateInput.addEventListener("input", function() {
      if (dateInput.value !== "") {
         ...
         dateInput.setAttribute("data-placeholder", placeholderText);
      }
   });
